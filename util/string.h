...
void i32_to_str(int v, char* out, int* len) {
...
int strlen(const char* str, int buffcap) { //buff cap due to buffer overflow
...
char* append_time_txt(char* s, int cap) {
    int n = strlen(s, cap);
...
void largeWrite(const char* fname) {
